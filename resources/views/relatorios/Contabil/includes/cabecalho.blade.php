    ...
    <div class="border border-dark mb-2 row bg-light" name="divCabecalho">
        ...
        <form action="{{route('site.relatorios.relatorioContabil')}}" method="get" name="dataCaixaEnviar" enctype="multipart/form-data"> {{csrf_field()}}
    ...
    <table class="  text-center table-sm col-md-6 ml-5  mb-1 mt-2 bg-white" >
            ...
            <tbody>
                ...
                <tr>
                    <tH scope="row" class="text-dark "> Relatório Contábil. </td>
                </tr>
                <tr>
                    <tH scope="row" class="text-primary"> Valores especificados pelas datas inseridas !!!</td>
                </tr>
